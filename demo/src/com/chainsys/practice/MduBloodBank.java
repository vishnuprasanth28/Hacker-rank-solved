...
public class MduBloodBank extends BloodBank {
	public static void main(String[]args) {
		...
		System.out.println("For donate blood type-yes or type-no for receive blood");//ask user whether they want donate or receive blood
		...
		if(donate.equalsIgnoreCase("yes")) {
			...
			if(isNewDonor.equalsIgnoreCase("yes")) {
				...
				if (hasConsumed.equalsIgnoreCase("yes")) {
					...
					System.out.println(donor.getDonorName()+" thank your for donating "+donor.getBloodGroup()+" blood" +" your id is : "+"MDU"+donor.getDonorId());
				}else {
